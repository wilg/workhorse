...
- Use Cursor plans, checkpoints, and concise clarifying questions when a marginal case needs a human decision.
- Use codebase search, grep, and relevant docs/tools to build coverage. Delegate independent search areas to subagents when useful.
